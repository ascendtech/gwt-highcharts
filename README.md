...
Add Dependency:
```gradle
  compile 'us.ascendtech:highcharts:1.3.3'
  compile 'us.ascendtech:highcharts:1.3.3:sources'
```
...
```gradle
  compile("us.ascendtech:highcharts:1.2.3")
  compile("us.ascendtech:highcharts:1.2.3:sources")
```
