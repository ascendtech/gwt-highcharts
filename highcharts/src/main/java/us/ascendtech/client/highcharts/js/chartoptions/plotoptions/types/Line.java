...
/**
 * @author Payam Meyer
 * Docs: https://api.highcharts.com/highcharts/plotOptions.line
 */
...
public class Line {
	...
	@JsOverlay
	public final Line setAllowPointSelect(Boolean allowPointSelect) {
	...
	@JsOverlay
	public final Line setAnimationLimit(double animationLimit) {
	...
	@JsOverlay
	public final Line setBoostThreshold(double boostThreshold) {
	...
	@JsOverlay
	public final Line setClassName(String className) {
	...
	@JsOverlay
	public final Line setColor(String color) {
		this.color = color;
		return this;
	}
	...
	@JsOverlay
	public final Line setColorIndex(double colorIndex) {
	...
	@JsOverlay
	public final Line setConnectEnds(Boolean connectEnds) {
	...
	@JsOverlay
	public final Line setConnectNulls(Boolean connectNulls) {
	...
	@JsOverlay
	public final Line setCropThreshold(double cropThreshold) {
	...
	@JsOverlay
	public final Line setCursor(String cursor) {
		this.cursor = cursor;
		return this;
	}
	...
	@JsOverlay
	public final Line setDashStyle(String dashStyle) {
	...
	@JsOverlay
	public final Line setDataLabels(SeriesDataLabels dataLabels) {
	...
	@JsOverlay
	public final Line setDescription(String description) {
	...
	@JsOverlay
	public final Line setEnableMouseTracking(Boolean enableMouseTracking) {
	...
	@JsOverlay
	public final Line setEvents(SeriesEvents events) {
		this.events = events;
		return this;
	}
	...
	@JsOverlay
	public final Line setExposeElementToA11y(Boolean exposeElementToA11y) {
	...
	@JsOverlay
	public final Line setFindNearestPointBy(String findNearestPointBy) {
	...
	@JsOverlay
	public final Line setGetExtremesFromAll(Boolean getExtremesFromAll) {
	...
	@JsOverlay
	public final Line setKeys(JsArray<String> keys) {
		this.keys = keys;
		return this;
	}
	...
	@JsOverlay
	public final Line setLabel(SeriesLabel label) {
		this.label = label;
		return this;
	}
	...
	@JsOverlay
	public final Line setLinecap(String linecap) {
	...
	@JsOverlay
	public final Line setLineWidth(double lineWidth) {
	...
	@JsOverlay
	public final Line setLinkedTo(String linkedTo) {
	...
	@JsOverlay
	public final Line setMarker(SeriesMarker marker) {
		this.marker = marker;
		return this;
	}
	...
	@JsOverlay
	public final Line setNegativeColor(String negativeColor) {
	...
	@JsOverlay
	public final Line setPoint(SeriesPoint point) {
		this.point = point;
		return this;
	}
	...
	@JsOverlay
	public final Line setPointInterval(double pointInterval) {
	...
	@JsOverlay
	public final Line setPointIntervalUnit(String pointIntervalUnit) {
	...
	@JsOverlay
	public final Line setPointPlacement(String pointPlacement) {
	...
	@JsOverlay
	public final Line setPointStart(double pointStart) {
	...
	@JsOverlay
	public final Line setSelected(Boolean selected) {
	...
	@JsOverlay
	public final Line setShowCheckbox(Boolean showCheckbox) {
	...
	@JsOverlay
	public final Line setShowInLegend(Boolean showInLegend) {
	...
	@JsOverlay
	public final Line setSkipKeyboardNavigation(Boolean skipKeyboardNavigation) {
	...
	@JsOverlay
	public final Line setSoftThreshold(Boolean softThreshold) {
	...
	@JsOverlay
	public final Line setStacking(String stacking) {
	...
	@JsOverlay
	public final Line setStates(SeriesStates states) {
		this.states = states;
		return this;
	}
	...
	@JsOverlay
	public final Line setStep(String step) {
		this.step = step;
		return this;
	}
	...
	@JsOverlay
	public final Line setStickyTracking(Boolean stickyTracking) {
	...
	@JsOverlay
	public final Line setThreshold(double threshold) {
	...
	@JsOverlay
	public final Line setTurboThreshold(double turboThreshold) {
	...
	@JsOverlay
	public final Line setVisible(Boolean visible) {
	...
	@JsOverlay
	public final Line setZoneAxis(String zoneAxis) {
	...
	@JsOverlay
	public final Line setZones(JsArray<SeriesZones> zones) {
		this.zones = zones;
		return this;
	}
}
