...
/**
 * @author Payam Meyer
 * Docs: https://api.highcharts.com/highcharts/plotOptions.pareto
 */
...
public class Pareto {
	...
	@JsOverlay
	public final Pareto setAllowPointSelect(Boolean allowPointSelect) {
	...
	@JsOverlay
	public final Pareto setAnimation(Animation animation) {
	...
	@JsOverlay
	public final Pareto setAnimationLimit(double animationLimit) {
	...
	@JsOverlay
	public final Pareto setClassName(String className) {
	...
	@JsOverlay
	public final Pareto setColor(String color) {
		this.color = color;
		return this;
	}
	...
	@JsOverlay
	public final Pareto setColorIndex(double colorIndex) {
	...
	@JsOverlay
	public final Pareto setConnectEnds(Boolean connectEnds) {
	...
	@JsOverlay
	public final Pareto setConnectNulls(Boolean connectNulls) {
	...
	@JsOverlay
	public final Pareto setCropThreshold(double cropThreshold) {
	...
	@JsOverlay
	public final Pareto setCursor(String cursor) {
		this.cursor = cursor;
		return this;
	}
	...
	@JsOverlay
	public final Pareto setDashStyle(String dashStyle) {
	...
	@JsOverlay
	public final Pareto setDataLabels(SeriesDataLabels dataLabels) {
	...
	@JsOverlay
	public final Pareto setDescription(String description) {
	...
	@JsOverlay
	public final Pareto setEnableMouseTracking(Boolean enableMouseTracking) {
	...
	@JsOverlay
	public final Pareto setEvents(SeriesEvents events) {
		this.events = events;
		return this;
	}
	...
	@JsOverlay
	public final Pareto setExposeElementToA11y(Boolean exposeElementToA11y) {
	...
	@JsOverlay
	public final Pareto setGetExtremesFromAll(Boolean getExtremesFromAll) {
	...
	@JsOverlay
	public final Pareto setLabel(SeriesLabel label) {
		this.label = label;
		return this;
	}
	...
	@JsOverlay
	public final Pareto setLinecap(String linecap) {
	...
	@JsOverlay
	public final Pareto setLineWidth(double lineWidth) {
	...
	@JsOverlay
	public final Pareto setLinkedTo(String linkedTo) {
	...
	@JsOverlay
	public final Pareto setMarker(SeriesMarker marker) {
		this.marker = marker;
		return this;
	}
	...
	@JsOverlay
	public final Pareto setPoint(SeriesPoint point) {
		this.point = point;
		return this;
	}
	...
	@JsOverlay
	public final Pareto setPointDescriptionFormatter(PointDescriptionFormatter pointDescriptionFormatter) {
	...
	@JsOverlay
	public final Pareto setSelected(Boolean selected) {
	...
	@JsOverlay
	public final Pareto setShowCheckbox(Boolean showCheckbox) {
	...
	@JsOverlay
	public final Pareto setShowInLegend(Boolean showInLegend) {
	...
	@JsOverlay
	public final Pareto setSkipKeyboardNavigation(Boolean skipKeyboardNavigation) {
	...
	@JsOverlay
	public final Pareto setStates(SeriesStates states) {
		this.states = states;
		return this;
	}
	...
	@JsOverlay
	public final Pareto setStickyTracking(Boolean stickyTracking) {
	...
	@JsOverlay
	public final Pareto setTooltip(Tooltip tooltip) {
	...
	@JsOverlay
	public final Pareto setTurboThreshold(double turboThreshold) {
	...
	@JsOverlay
	public final Pareto setVisible(Boolean visible) {
